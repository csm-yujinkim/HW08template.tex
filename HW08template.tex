...
\begin{document}
	...
	\begin{enumerate} [a.]
		...
		\begin{itemize}
			...
			For all $x\in\mathbb{N}$ that is also even, $x/2$ will be either even or odd.
			$E$ will contain $0$ and $1$.

			For all $x\in\mathbb{N}$ that is also odd, $x+1$ will be even and greater than 1.
			$O$ will contain all integers greater than 1.
